...
"[project]/src/app/api/admin/wineries/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/winery.model.ts [app-route] (ecmascript)");
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        const winery = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!winery) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (user.role !== "admin" && String(winery.owner) !== String(userId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Forbidden: You do not have permission to delete this winery."
            }, {
                status: 403
            });
        }
        const deletedWinery = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(request, { params }) {
    ...
    try {
        ...
        if (user.role !== "admin" && String(winery.owner) !== String(userId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Forbidden: You do not have permission to update this winery."
            }, {
                status: 403
            });
        }
        const data = await request.json();
        const updatedWinery = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, data, {
            new: true
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__da2de5._.js.map