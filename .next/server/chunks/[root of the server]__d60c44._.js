...
"[project]/src/app/api/winery/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!user || user.role !== "winery" && user.role !== "admin") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Forbidden: Only winery or admin users can create a winery."
            }, {
                status: 403
            });
        }
        const data = await req.json();
        const winery = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            ...data,
            owner: userId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function GET(req) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbConnect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbConnect"])();
        const wineries = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().lean();
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$winery$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "sucess",
            wineries,
            total
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d60c44._.js.map