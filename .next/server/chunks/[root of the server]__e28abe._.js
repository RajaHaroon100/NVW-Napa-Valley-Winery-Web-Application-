...
async function GET(request) {
    try {
        ...
        if (user.role === "winery") {
            ...
            const wineries = await (await __turbopack_require__("[project]/src/models/winery.model.ts [app-route] (ecmascript, async loader)")(__turbopack_import__)).default.find({
                owner: userId
            }).select("_id");
            const wineryIds = wineries.map((w)=>w._id);
            bookingQuery = {
                "wineries.wineryId": {
                    $in: wineryIds
                }
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$booking$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(bookingQuery).sort({
            createdAt: -1
        }).populate({
            path: "userId",
            model: "User",
        ...
        const totalBookings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$booking$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(bookingQuery);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            bookings,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e28abe._.js.map